    ...
    <div class="col-md-9 col-lg-9">
        <div class="panel panel-default panel-body">
            ...
            if (isset($pdo)) {
                ...
                $sqlTeamName = "SELECT Team.Bezeichnung AS Bezeichnung FROM BenutzerTeam, Team, Arbeitspaket WHERE BenutzerTeam.TeamID = Team.TeamID AND Arbeitspaket.TeamID = Team.TeamID AND BenutzerTeam.EMail ='" . $email . "' GROUP BY Bezeichnung";
                ...
                foreach ($pdo->query($sqlTeamName) as $teamName) {
                    ...
                    $sqlToDosProTeam = "SELECT Team.Bezeichnung AS TeamBezeichnung, ToDos.Bezeichnung AS ToDosBezeichnung, ToDos.Status AS ToDosStatus FROM Team, Arbeitspaket, ToDos WHERE Team.TeamID = Arbeitspaket.TeamID AND Arbeitspaket.ArbeitspaketID = ToDos.ArbeitspaketID  AND Team.Bezeichnung='" . $teamName["Bezeichnung"] . "' AND Arbeitspaket.ProjektID='" . $project . "' ";
                    
                    //Zweite Schleife erstellt die Tabelle
                    $stringTable .= "<div id=\"" . $teamName["Bezeichnung"] . "\" class=\"tab-pane fade\"><table class=\"table table-striped\"><tr> <th>TeamBezeichnung</th> <th>ToDosBezeichnung</th> <th>ToDosStatus</th></tr>";

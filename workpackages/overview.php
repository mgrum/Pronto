...
if (isset($pdo)) {
    //TODO
    $wp = $_GET['workpackage'];
    // $sqlProject = "SELECT ArbeitspaketID, Bezeichnung, FAZ, SAZ, FEZ, SEZ, GP, FP, RealCase, BestCase, WorstCase, PERT, Meilenstein, VorgängerID, ProjektID, TeamID FROM Arbeitspaket";
    $sqlProject = "SELECT Bezeichnung FROM Arbeitspaket WHERE ArbeitspaketID = " . $wp;
...
<div class="row">
    <div class="col-md-12 col-lg-12">
        <div class="panel panel-default panel-body panel-header">
            <h2>Arbeitspaket: <b><?php echo $wpm ?></b></h2>
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="col-md-9 col-lg-9">
        <div class="panel panel-default panel-body">
            ...
            if (isset($pdo)) {
                ...
                $wp = $_GET['workpackage'];
                // $sqlProject = "SELECT ArbeitspaketID, Bezeichnung, FAZ, SAZ, FEZ, SEZ, GP, FP, RealCase, BestCase, WorstCase, PERT, Meilenstein, VorgängerID, ProjektID, TeamID FROM Arbeitspaket";
                $sqlProject = "SELECT * FROM Arbeitspaket WHERE ArbeitspaketID = " . $wp;
    
                ?>
                <div id=" Workpackage" class="tab-pane">
                    <table class="table table-striped">
                        ...
                        foreach ($pdo->query($sqlProject) as $row) {
                            ...
                            echo "<tr> <td><b>VorgängerID</b></td> <td>" . $row ["VorgaengerID"] . "</td></tr>";
                ...
                if ($_SESSION["role"] = 'Projektleiter') {
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal2">ToDo
                        erstellen
                    </button>
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group">
                                            <label for="recipient-name"
                                                   class="form-control-label">Arbeitpaket-ID:</label>

<!--Description: This page shows the network diagram for the current project-->
    ...
    <div class="col-md-9 col-lg-9">
        <div class="panel panel-default panel-body">
            ...
            <div id="sample">
                ...
                <p>
                    This sample demonstrates how to create a simple PERT chart. A PERT chart is a project management
                    tool used to schedule and coordinate tasks within a project.
                </p>
                <p>
                    ...
                    The lines separating the text are implemented by setting the
                    <a>RowColumnDefinition.separatorStroke</a>
                ...
                <p>
                    The "critical" property on the activity data object controls whether the node is drawn with a red
                    brush or a blue one.
                    There is a special converter that is used to determine the brush used by the links.
                </p>
                <p>
                    The light blue legend is implemented by a separate Part implemented in a manner similar to the Node
                    template.
                    However it is not bound to data -- there is no JavaScript object in the model representing the
                    legend.
                </p>
            </div>
        </div>
